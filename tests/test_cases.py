...
Case files with the string "target" in them will be run as CPF problems instead of
PF/OPF problems.

The output JSON file includes both the problem and solution, as well as supporting
information about the test environment.

Before running the test cases, the script also runs the tox tests in the pypower 
folder.

To run the test procedure, use the following command:
...
* `2`: one of more unit tests failed
"""
