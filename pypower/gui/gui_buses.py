...
class buses_ui(QtGui.QVBoxLayout): 
    ...
    def setup(self, window):   
        ...
        headings = ['Bus ID', 'Type', 'Load P', 'Load Q', 'Shunt G', 'Shunt B', 'Area', 'Vm', 'Vang', 'Base kV', 'Zone', 'Vmax', 'Vmin']
    ...
    def update_data_matrix(self, tableWidgetItem): 
        ...
        if tableWidgetItem.column() == 0:
            ...
            upper_bound = 360.0
            lower_bound = -360.0
            value = gui_utility.validate(tableWidgetItem.text(), lower_bound, upper_bound, l_inclusive = True, u_inclusive = True)
        ...
        if value is not False:   
            ...
            self.main_window.show_status_message("Bus row " + str(tableWidgetItem.row() + 1) + " - " + element +  ": Input value '" + tableWidgetItem.text() + "' out of bounds. (" + str(lower_bound) + " to " + str(upper_bound) + "). Value not set.", error = True, beep = True)
