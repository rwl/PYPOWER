...
def test_se_14bus():
    ...
    """
    idx = dict()
    idx["idx_zPF"] = array([0, 2, 7, 8, 9, 12, 14, 15, 16, 18])
    idx["idx_zPT"] = array([3, 4, 6, 10])
    idx["idx_zPG"] = array([0, 1, 2, 3, 4])
    idx["idx_zVa"] = array([])
    idx["idx_zQF"] = array([0, 2, 7, 8, 9, 12, 14, 18])
    idx["idx_zQT"] = array([3, 4, 6, 10])
    idx["idx_zQG"] = array([0, 1])
    idx["idx_zVm"] = array([1, 2, 5, 7, 9, 13])

    ## specify measurements
    measure = dict()
    measure["PF"] = array([1.5708, 0.734, 0.2707, 0.1546, 0.4589, 0.1834, 0.2707, 0.0523, 0.0943, 0.0188])
    measure["PT"] = array([-0.5427, -0.4081, 0.6006, -0.0816])
    measure["PG"] = array([2.32, 0.4, 0, 0, 0])
    measure["Va"] = array([])
    ...
    measure["Vm"] = array([1, 1, 1, 1, 1, 1], float)
